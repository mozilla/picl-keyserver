...
module.exports = {
  ...
  // This is the same the email prereq, but for GET requests
  emailGet: {
    method: 'email(query.email)'
  },
  // This is the same the assertion prereq, but for GET requests
  assertionGet: {
    method: 'verify(query.assertion, server.settings.uri)',
    assign: 'email'
  },
  userId: {
